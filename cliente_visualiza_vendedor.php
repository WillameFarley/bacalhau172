...
<table width="100%" border="0" cellpadding="0" cellspacing=" 0">
  <tr>
    ...
    <td class="style19"><strong><b><span class="style1">VISUALIZAR CLIENTE</span></b><br />
  ...
  <tr>
    ...
    <td><table width="100%" border="0">
        <tr bgcolor="#FFFFCC">
          ...
          <td width="26%" class="style16"><strong>Nome</strong></td>
          <td width="21%" class="style16"><strong>Fone Resid.</strong></td>
          <td width="21%" class="style16"><strong>Fone Com.</strong></td>
          <td width="21%" class="style16"><strong>Celular</strong></td>
        </tr>
        <?php do { ?>
        <tr>
          <td class="style19"><a href="cliente_visualizax_vendedor.php?recordID=<?php echo $row_Recordset1['codigo']; ?>" class="style18"> <?php echo $row_Recordset1['codigo']; ?></a> </td>
          <td class="style19"><strong><?php echo $row_Recordset1['nome']; ?></strong></td>
          <td class="style19"><?php echo $row_Recordset1['fone_res']; ?></td>
          <td class="style19"><?php echo $row_Recordset1['fone_com']; ?></td>
          <td class="style19"><?php echo $row_Recordset1['celular']; ?></td>
        </tr>
