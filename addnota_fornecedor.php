...
<table width="100%" border="0" cellpadding="0" cellspacing=" 0">
  <tr>
    ...
    <td class="style7 style13 style13"><p><b><span class="style1">NOVA NOTA FISCAL DE COMPRAS</span><br />
      SYSESTOQUE ::: BACALHAU 172<br />
    <b><b><a href="fechar.php"> Fechar Janela</a></b></b></b></p></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><form id="form1" name="form1" method="get" action="addnota_fornecedor1.php">
      <table width="551" border="0">
        <tr>
          <td width="241" class="style7 style13 style13"><div align="right">Localizar Fornecedor pelo Nome de Fantasia:</div></td>
