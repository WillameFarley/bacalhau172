...
$query_Recordset1 = sprintf("SELECT * FROM ordemservico WHERE Funcionario LIKE %s and Arquivo = 'n' ORDER BY Funcionario ASC", GetSQLValueString($colname_Recordset1 . "%", "text"));
