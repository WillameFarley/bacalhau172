...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO notadecompra (Cliente, numerodanota, data_emissao, cpf, insc_estadual, Prod1, Prod2, Prod3, Quant1, Quant2, Quant3, Valor1, Valor2, Valor3, totalNotaFiscal, obs) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
document.form1.multiplica1.value = (eval(document.form1.Quant1.value) * eval(document.form1.Valor1.value));
}

function multiplicar2(){
document.form1.multiplica2.value = (eval(document.form1.Quant2.value) * eval(document.form1.Valor2.value));
}

function multiplicar3(){
document.form1.multiplica3.value = (eval(document.form1.Quant3.value) * eval(document.form1.Valor3.value));
}

function somatotalnota(){
document.form1.soma.value = (eval(document.form1.multiplica1.value) + eval(document.form1.multiplica2.value) + eval(document.form1.multiplica3.value));
}
</script>
...
<td width="940"><b><span class="style1">EDI&Ccedil;&Atilde;O DE CLIENTE</span><br />
      ...
      <form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="form1">
        <tr>
          <td width="100%" height="40" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="12%" align="left" valign="top"><b>Data da<br />
              ...
              <td width="88%" align="left" valign="top"><b>N&ordm; da <br />
                Nota:</b><b><br />
                </b><b>
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing=" 0" cellpadding="0">
            <tr>
              ...
              <input name="Quant1" type="text" class="select" id="Quant1" onkeyup="multiplicar1()" size="5" maxlength="10" />
              </b><br /></td>
              <td width="11%" valign="top"><b>Valor:</b><br />
                <b>
                <input name="Valor1" type="text" class="select" id="Valor1" onkeyup="multiplicar1()" size="10" maxlength="10" />
                <input name="multiplica1" type="text" class="select" id="multiplica1" onkeyup="somatotalnota" size="5" maxlength="10" />
                </b></td>
              <td width="49%" rowspan="3" valign="top"><b>                Observa&ccedil;&otilde;es Diversas:</b><br />
                <b>
                ...
                Total da Nota:</b><br />
                <b>
                <input name="soma" type="text" class="select" size="15" maxlength="15" />
                </b></td>
            </tr>
            <tr valign="top">
              <td><b>Produto:</b><br />
              ...
              <td><b>Quantidade:<br />
                <input name="Quant2" type="text" class="select" id="Quant2" onkeyup="multiplicar2()" size="5" maxlength="10" />
              </b><br /></td>
              <td><b>Valor:</b><br />
                  <b>
                  <input name="Valor2" type="text" class="select" id="Valor2" onkeyup="multiplicar2()" size="10" maxlength="10" />
                  <input name="multiplica2" type="text" class="select" id="multiplica2" onkeyup="somatotalnota" size="5" maxlength="10" />
</b></td>
              </tr>
            <tr valign="top">
              <td><b>Produto:</b><br />
              ...
              <td><b>Quantidade:<br />
                <input name="Quant3" type="text" class="select" id="Quant3" onkeyup="multiplicar3()" size="5" maxlength="10" />
              </b><br /></td>
              <td><b>Valor:</b><br />
                  <b>
                  <input name="Valor3" type="text" class="select" id="Valor3" onkeyup="multiplicar3()" size="10" maxlength="10" />
                  <input name="multiplica3" type="text" class="select" id="multiplica3" onkeyup="somatotalnota" size="5" maxlength="10" />
</b></td>
              </tr>
