...
<table width="100%" border="0" cellpadding="0" cellspacing=" 0">
  <tr>
    ...
    <td class="style19"><b>SYSESTOQUE ::: BACALHAU 172<br />
  ...
  <tr>
    ...
    <td><table width="100%" border="1" bordercolor="#CCCCCC">
        <tr bgcolor="#FFFFCC">
          ...
          <td width="41%" class="style16"><strong>Cliente</strong></td>
          <td width="22%" class="style16"><strong>CPF / CNPJ</strong></td>
          <td width="24%" class="style16"><strong>Raz&atilde;o Social</strong></td>
        </tr>
        <?php do { ?>
        <tr>
          <td><a href="add_os1.php?recordID=<?php echo $row_Recordset1['codigo']; ?>" class="style18"> <span class="style17"><?php echo $row_Recordset1['codigo']; ?></span></a> </td>
          <td><a href="add_os1.php?recordID=<?php echo $row_Recordset1['codigo']; ?>" class="style18"> <span class="style17"><?php echo $row_Recordset1['nome']; ?></span></a> </td>
          <td><span class="style19"><?php echo $row_Recordset1['cpf']; ?></span> </td>
          <td class="style19"><?php echo $row_Recordset1['nome_razao']; ?></td>
        </tr>
...
<a href="addos_cliente.php" class="style19">Fazer nova busca</a>
</body>
</html>
<?php
