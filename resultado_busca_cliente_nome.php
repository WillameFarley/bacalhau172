  ...
  <tr>
    ...
    <td colspan="2"><table width="100%" height="56" border="0">
        ...
        <tr>
          ...
          <td width="8%"><strong><a href="excluir_cliente.php?codigo=<?php echo $row_Recordset1['codigo']; ?>">EXCLUIR</a></strong></td>
          <td width="8%"><strong><a href="edd_clientes.php?codigo=<?php echo $row_Recordset1['codigo']; ?>">EDITAR</a></strong></td>
        </tr>
