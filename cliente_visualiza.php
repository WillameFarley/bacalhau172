...
<table width="100%" border="0" cellpadding="0" cellspacing=" 0">
  ...
  <tr>
    ...
    <td><table width="100%" border="0">
        ...
        <?php do { ?>
        <tr>
          <td class="style19"><a href="cliente_visualizax.php?recordID=<?php echo $row_Recordset1['codigo']; ?>" class="style18"> <?php echo $row_Recordset1['codigo']; ?></a> </td>
          <td class="style19"><?php echo $row_Recordset1['nome']; ?></td>
