...
<form ACTION="<?php echo $loginFormAction; ?>" method="POST" name="form1" id="form1">
  <table width="100%" border="0" cellspacing=" 0" cellpadding="0">
    ...
    <tr>
      <td valign="top"><div align="center">&Aacute;rea 
        restrita para funcion&aacute;rios do Bacalhau 172.<br />
        Digite nos 
        campos abaixo o seu usuário e senha e clique no bot&atilde;o 
        acessar<br />
        <br />
