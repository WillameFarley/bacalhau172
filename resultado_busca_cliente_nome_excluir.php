...
<table width="100%" border="0" cellpadding="0" cellspacing=" 0">
  <tr>
    <td width="40"><div align="center"><img src="Imagens/cadeado.gif" alt="" width="30" height="30" /></div></td>
    <td width="276"><strong><b>SYSESTOQUE ::: BACALHAU 172</b><br />
        <b><b><a href="fechar.php">Fechar Janela</a></b></b></strong></td>
    <td width="710"><table border="0">
      <tr>
  ...
  <tr>
    ...
    <td colspan="2"><table width="100%" height="56" border="1" bordercolor="#CCCCCC">
        <tr bgcolor="#FFFFCC">
          ...
          <td width="34%" align="center"><strong>NOME DO CLIENTE / NOME DE FANTASIA</strong></td>
          <td width="34%" align="center"><strong>RAZ&Atilde;O SOCIAL</strong></td>
          <td width="17%" align="center"><strong>CPF / CNPJ</strong></td>
        ...
        <tr>
          ...
          <td align="center"><strong><a href="excluir_cliente.php?codigo=<?php echo $row_Recordset1['codigo']; ?>">EXCLUIR</a></strong></td>
          </tr>
