  ...
  <tr>
    <td colspan="2">
      ...
      <form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="form1">
        <tr>
          <td width="100%" height="40" valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
            <tr>
          ...
          <table width="98%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="324" valign="top"><b>Cliente:</b><br />
                <span class="style14"><?php echo $row_DetailRS1['nome_razao']; ?></span>              </td>
              <td width="134" valign="top"><b class="style9">CPF/CNPJ:</b><br />
                  <span class="style14"><?php echo $row_DetailRS1['cpf']; ?></span></td>
              <td width="322" valign="top"><b class="content">Inscri&ccedil;&atilde;o Estadual:</b><br />
                  <span class="style14"><?php echo $row_DetailRS1['insc_estadual']; ?></span></td>
            </tr>
          </table>
            <table width="98%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                </b></span><span class="style13 style7 style15"><?php echo $row_DetailRS1['fone_com']; ?></span><strong> /</strong><span class="style14"> <?php echo $row_DetailRS1['fone_res']; ?></span> <strong>/</strong><span class="style13 style7 style15"> <?php echo $row_DetailRS1['celular']; ?></span><br />
                <b class="content">E-mail:</b><br />
