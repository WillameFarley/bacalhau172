...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO ordemservico (Funcionario, Data_Entrada, Hora_Entrada, Cliente, Prazo_Pgto, Patrimonio, Data_Entrega, Hora_Entrega, taxaEntrega, Prod1, Prod2, Prod3, Prod4, Prod5, Quant1, Quant2, Quant3, Quant4, Quant5, Valor1, Valor2, Valor3, Valor4, Valor5) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['taxaEntrega'], "text"),					   
...
<table width="956" border="0" cellpadding="0" cellspacing=" 0">
  <tr>
    ...
    <td width="945"><b><span class="style1">NOVO PEDIDO</span><br />
          ...
          <td width="100%" height="40" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="324" valign="top"><b>Cliente:</b><br />
                  <input name="Cliente" readonly="readonly" type="text" id="Cliente" onkeyup="muda(this)" value="<?php echo $row_DetailRS1['nome']; ?>" size="45"/>
              </td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="348"><span class="first"><strong>Endere&ccedil;o:</strong></span><br />
                    <span class="style14"> <?php echo $row_DetailRS1['endereco']; ?> <?php echo $row_DetailRS1['numero1']; ?>  <?php echo $row_DetailRS1['complemento1']; ?><br />
            ...
            <tr>
              <td width="28%"><b>Produto:</b><br />
                        ...
                        <select name="Prod1" class="select" id="Prod1">
                          ...
                          <option value="Bacalhau Dessalgado 1 Pe&ccedil;a em bandeja">Bacalhau Dessalgado 1 Pe&ccedil;a em bandeja</option>
                          <option value="Bol&atilde;o de 50 g">Bol&atilde;o de 50 g</option>
                          <option value="Bol&atilde;o de 50 g saco branco">Bol&atilde;o de 50 g saco sem logo</option>
                          <option value="Bolinha de Queijo 400g -  25unid">Bolinha de Queijo 400g -  25unid</option>
                          <option value="Bolinhos de Bacalhau">Bolinhos de Bacalhau</option>
                          <option value="Camar&atilde;o Empanado Pct 500g -  25unid">Camar&atilde;o Empanado Pct 500g -  25unid</option>
                          <option value="Charutos de 15 g">Charutos de 15 g</option>
                          <option value="Charutos de 25 g">Charutos de 25 g</option>
                          <option value="Charutos de 50 g">Charutos de 50 g</option>                          
                          <option value="Charutos de 75 g">Charutos de 75 g</option>
                          <option value="Comum 25 g p&ccedil; 500g">Comum 25 g p&ccedil; 500g</option>
                          <option value="Comum 25 g">Comum 25 g</option>
                          <option value="Comum 25 g saco branco ">Comum 25 g saco sem logo </option>
                          <option value="Comum 30 g">Comum 30 g</option>
                          <option value="Comum 30 g saco branco">Comum 30 g saco sem logo</option>
						  ...
						  <option value="Coquetel 15 g">Coquetel 15 g</option>
                          <option value="Coquetel 15 g saco branco">Coquetel 15 g saco sem logo</option>
                          <option value="Coquetel 12,5 g a v&aacute;cuo">Coquetel 12,5 g a v&aacute;cuo</option>
                          <option value="Coquetel 12,5 g - 50 unid golosita">Coquetel 12,5 g c/ 50 un golosita</option>
                          <option value="Coquetel 18 g c/ 25 unid golosita">Coquetel 18 g c/ 25 un golosita</option>
                          <option value="Coquetel 20 g">Coquetel 20 g</option>
                          <option value="Coxinha de Frango Pct 450g -  25unid">Coxinha de Frango Pct 450g -  25unid</option>
                          <option value="Croquete de Feijoada Pct 400g -  25unid">Croquete de Feijoada Pct 400g -  25unid</option>
                          <option value="Kibe Recheado Pct 400g -  25unid">Kibe Recheado Pct 400g -  25unid</option>
                          <option value="Massa fresca">Massa fresca</option>
						  <option value="Sufle 220g congelado<">Sufle 220g congelado</option>
                        </select>
                        </b></td>
              ...
              <td width="49%" rowspan="5" valign="top"><b>Observa&ccedil;&otilde;es Diversas:</b><br />
                <b>
                <textarea name="obs" cols="60" rows="7" class="select" id="obs" onkeyup="muda(this)"></textarea>
                <br />
                Taxa de Entrega: <br />
                <input name="taxaEntrega" type="text" class="select" id="taxaEntrega" size="13" maxlength="10" />
<br /></b></td>
            </tr>
            <tr>
              <td><b>Produto:</b><br />
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="17%" valign="top"><b>Quem recebe o pedido:</b><br />
                  <b>
                  <input name="Patrimonio" type="text" class="select" id="Patrimonio" size="20" maxlength="50" />
                  </b></p>                </td>
              ...
              <td width="15%" valign="top"><b>Hora 
                da Entrega: <br />
                  <input name="Hora_Entrega" type="text" class="select" id="Hora_Entrega" size="13" maxlength="255" />
              </b></td>
              ...
              <td colspan="2" valign="top"><b>Prazo de Pgto:</b><br />
                <b>
                <input name="Prazo_Pgto" type="text" class="select" id="Prazo_Pgto" size="13" maxlength="255" />
                </b></td>
              </tr>
            <tr>
              <td valign="top">&nbsp;</td>
