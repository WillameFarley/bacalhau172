...
mysql_free_result($rsVerificador);
 ...
 $insertSQL = sprintf("INSERT INTO cliente (codigo, nome, tipocliente, cpf, dn, email, fone_com, fone_res, celular, endereco, numero1, complemento1, referencia1, endereco2, endereco3, bairro, bairro2, bairro3, cidade, estado, cep, cep2, cep3, vendedor, porcentagem, data_cadastro, link_mapa) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, NOW(), %s)",
...
//		GetSQLValueString($_POST['data_cadastro'], NOW()),
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing=" 0">
    <tr>
      ...
      <td width="360"><ul class="nav">
          <li><a href="add_clientes_jur.php" target="palco"> <strong>CLIQUE AQUI PARA CADASTRAR PESSOA JURÍDICA</strong></a></li>
      </ul></td>
    </tr>
  </table>
  <table width="872" border="0" cellpadding="2" cellspacing="2" class="verdana" >
    ...
    <tr>
      <td colspan="2"><font color="#666666"><b>Nome:</b><br />
            <input name="nome" type="text" class="select" id="nome" size="40" maxlength="80" />
      </font></td>
      <td colspan="2"><b><font color="#666666"><b>CPF:</b><br />
        <b>
        <input type="text" name="cpf" class="select" onkeypress="formatar(this, '###.###.###-##')"maxlength="14" size="15" />
      </b></font></b></td>
<td><b><font color="#666666"><b>Data de Nasc:</b><br />
  <b>
    <input type="date" name="dn" class="select" onkeypress="formatar(this, '##/##/####')"maxlength="10" size="15" />
  </b></font></b></td>
<td width="128" valign="top"><font color="#666666"><b>Vendedor:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><br />
    <b>
    <input name="vendedor" type="text" class="select" id="vendedor" maxlength="20" size="9" />
    </b><b><br />
              </b></font></td>
  <td width="108" valign="top"><font color="#666666"><b>Comiss&atilde;o:
        <br />
        <input name="porcentagem" type="text" class="select" id="porcentagem" maxlength="2" size="1" />
  </b></font></font></td>
    </tr>
    <tr>
      <td colspan="2" valign="top"><font color="#666666"><b>Endere&ccedil;o:</b><br />
<b>
            <input name="endereco" type="text" class="select" id="endereco" size="40" maxlength="100" />
            <br />
</b></font></td>
      <td colspan="2" valign="top"><font color="#666666"><b>N&uacute;mero:</b><br />
        <b>
        <input name="numero1" type="text" class="select" id="numero1"  size="10" maxlength="30"/>
        </b></font></td>
      <td width="108" valign="top"><font color="#666666"><b>
        Bairro:<br />
        <input name="bairro" type="text" class="select" id="bairro"  size="18" maxlength="30"/>
      </b></font></td>
      <td width="178" valign="top"><font color="#666666"><b> Cep:<br />
        <input name="cep" type="text" class="select" id="cep" onkeypress="formatar(this, '#####-###')" size="10" maxlength="9"/>
      </b></font></td>
      <td width="178" valign="top">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="2" valign="top"><font color="#666666"><b>Complemento:</b><br />
          <b>
          <input name="complemento1" type="text" class="select" id="complemento1" size="40" maxlength="100" />
      </b></font></td>
      <td colspan="3" valign="top"><font color="#666666"><b>Ponto de Refer&ecirc;ncia:</b><br />
        <b>
        <input name="referencia1" type="text" class="select" id="referencia1"  size="30" maxlength="50"/>
      </b></font></td>
      <td width="178" valign="top">&nbsp;</td>
      <td width="178" rowspan="2" valign="top">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="2" valign="top"><font color="#666666"><b>Fone 
Comercial:</b><br />
<b>
<input type="text" name="fone_com" class="select" maxlength="36" size="13" />
</b><b></b></font></td>
      <td colspan="3" valign="top"><font color="#666666"><b>Fone 
        Resid:</b><br />
        <b>
        <input type="text" name="fone_res" class="select" maxlength="36" size="13" />
      </b><b></b></font></td>
      <td width="178" valign="top"><font color="#666666"><b>Celular:<br />
            <input type="text" name="celular" class="select" maxlength="36" size="13" />
      </b></font></td>
    </tr>
    <tr>
      <td colspan="2" valign="top"><font color="#666666"><b>Endere&ccedil;o 2:</b><br />
            <b>
            <input name="endereco2" type="text" class="select" id="endereco2" size="40" maxlength="100" />
          </b></font></td>
      <td colspan="3" valign="top"><font color="#666666"><b>Bairro 2:</b><br />
        <b>
        <input type="text" name="bairro2" class="select" maxlength="30" size="35" />
      </b></font></td>
      <td width="178" valign="top"><font color="#666666"><b> Cep. 2:<br />
    ...
    <tr>
      <td colspan="2" valign="top"><font color="#666666"><b>Endere&ccedil;o 3:</b><br />
            <b>
            <input name="endereco3" type="text" class="select" id="endereco3" size="40" maxlength="100" />
          </b></font></td>
      <td colspan="3" valign="top"><font color="#666666"><b>Bairro 3:</b><br />
        <b>
        <input type="text" name="bairro3" class="select" maxlength="30" size="35" />
      </b></font></td>
      <td width="178" valign="top"><font color="#666666"><b> Cep. 3:<br />
        <input name="cep3" type="text" class="select" id="cep3" onkeypress="formatar(this, '#####-###')" size="10" maxlength="9"/>
      </b></font></td>
<td width="178" valign="top">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="2" valign="top"><font color="#666666"><b>Cidade:</b><br />
            <b>
            <input name="cidade" type="text" class="select"  value="RIO DE JANEIRO" size="35" maxlength="30"/>
          </b><br />
      </font></td>
      <td colspan="3" valign="top"><b><font color="#666666"><b>Tipo de Cliente:<br />
        <font color="#666666"><b>
...
<td valign="top"><font color="#666666"><b>E-Mail:</b><br />
        <b>
          <input name="email" type="text" class="select" id="email" size="25" maxlength="50" />
      </b> </font></td>
<td valign="top">&nbsp;</td>
    </tr>
    <tr>
      <td width="155" valign="top"><font color="#666666"><b>Estado:</b><br />
      ...
      <td width="71" valign="top"><font color="#666666"><br />
      </font></td>
      <td colspan="3" valign="top"><b><font color="#666666"><b><font color="#666666"><b>Grupo de Cliente:<br />
        ...
        <select spry:sort="$tipo_cliente" name="tipo_cliente" id="tipo_cliente">
          ...
          <option>Ag&ecirc;ncia O GLOBO</option>
          <option>Prefeitura</option>
          <option>2&ordf; CRE</option>
          <option>PUC</option>
          <option>CNC</option>
          <option>INCA</option>
          ...
          <option>Est&aacute;cio de S&aacute;</option>
          <option>PROEN</option>
          <option>OAB</option>
          <option>Ita&uacute; Personalit&eacute;</option>
          <option>Technical Books</option>
          <option>Bradesco Seguros</option>
          <option>LIGHT</option>
          <option>H. Stern</option>
          <option>Loja Paquet&aacute;</option>
          <option>Procuradoria</option>
          <option>CESGRANRIO</option>
          <option>C&acirc;mara Municipal do RJ</option>
          <option>Correios</option>
          <option>Cart&oacute;rio 9o Of&iacute;cio</option>
          <option>Renoma</option>
          <option>Aboli&ccedil;&atilde;o Ve&iacute;culos</option>
          <option>Avanti Ve&iacute;culos Fiat</option>
    ...
    <tr>
      <td colspan="7" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="verdana">
          <tr>
            <td><font color="#666666"><b>Link do Mapa:
                  <input name="link_mapa" type="text" class="select" id="link_mapa" size="80" maxlength="1000"/>
            </b></font></td>
          </tr>
