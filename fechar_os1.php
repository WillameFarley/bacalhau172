...
<table width="100%" border="0" cellpadding="0" cellspacing=" 0">
  <tr>
    ...
    <td class="style7 style13 style13"><strong><b>SYSESTOQUE ::: BACALHAU 172</b><br />
        <b><b><a href="fechar.php">Fechar Janela</a></b></b></strong></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><form id="form1" name="form1" method="get" action="resultado_fecharbusca_os1.php">
      <table width="332" border="0">
        <tr>
          <td width="178" class="style7 style13 style13">Fechar Pedido pelo Numero:</td>
            <td width="144"><div align="right">
              <span class="style7 style13 style13">
                <input type="text" name="Cod_Equipamento" id="Cod_Equipamento" />
              </span></div></td>
          </tr>
        <tr>
          <td>&nbsp;</td>
