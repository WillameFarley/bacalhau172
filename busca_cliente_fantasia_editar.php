...
<table width="100%" border="0" cellpadding="0" cellspacing=" 0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td><form id="form1" name="form1" method="get" action="resultado_busca_cliente_fantasia_editar.php">
      <table width="435" border="0">
        <tr>
          <td width="276" class="style7 style13 style13"><div align="right">Localizar Cliente pelo <strong>Nome de Fantasia</strong>:</div></td>
