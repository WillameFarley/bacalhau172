            ...
            <tr>
              <td width="28%"><b>Produto:</b><br />
                        ...
                        <select name="Prod1" class="select" id="Prod1">
                          ...
                          <option value="Comum 25 g pç 500g">Comum 25 g pç 500g</option>
						  ...
						  <option value="Torta familia 1 kg congelada">Torta familia 1 kg congelada</option>
						  <option value="Tortinha 220g congelada">Tortinha 220g congelada</option>
                        </select>
                        </b></td>
