...
<table width="100%" border="0" cellpadding="0" cellspacing=" 0">
  ...
  <tr>
    ...
    <td colspan="2"><table width="100%" border="0">
        ...
        <?php do { ?>
        <tr>
          <td><a href="addnotafiscal.php?recordID=<?php echo $row_Recordset1['codigo']; ?>" class="style18"> <span class="style17 style1"><?php echo $row_Recordset1['codigo']; ?></span></a> </td>
          <td><a href="addnotafiscal.php?recordID=<?php echo $row_Recordset1['codigo']; ?>" class="style18"> <span class="style17 style1"><?php echo $row_Recordset1['fantasia']; ?></span></a></td>
...
<a href="addnota_cliente.php" class="style19">Fazer nova busca</a>
</body>
</html>
<?php
