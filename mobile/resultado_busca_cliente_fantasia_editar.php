...
if (isset($_GET['fantasia'])) {
  $colname_Recordset1 = $_GET['fantasia'];
}
mysql_select_db($database_data, $data);
$query_Recordset1 = sprintf("SELECT * FROM cliente WHERE fantasia LIKE %s ORDER BY fantasia ASC", GetSQLValueString("%" . $colname_Recordset1 . "%", "text"));
...
<table width="100%" border="0" cellpadding="0" cellspacing=" 0">
  ...
  <tr>
    ...
    <br />
    <a href="excluir_cliente.php?codigo=<?php echo $row_Recordset1['codigo']; ?>"></a></strong></td>
    <td colspan="2"><table width="100%" height="56" border="1" bordercolor="#CCCCCC">
        <tr bgcolor="#FFFFCC">
          <td width="7%" height="18" align="center"><strong>C&Oacute;DIGO</strong></td>
          <td width="24%" align="center"><strong>NOME DO CLIENTE</strong></td>
          <td width="24%" align="center"><strong>RAZ&Atilde;O SOCIAL</strong></td>
          <td width="24%" align="center"><strong>NOME DE FANTASIA</strong></td>
          <td width="13%" align="center"><strong>CPF / CNPJ</strong></td>
          <td width="8%" align="center"><strong>A&Ccedil;&Atilde;O</strong></td>
        </tr>
        <?php do { ?>
        <tr>
          <td height="24"><a href="cliente_visualizax.php?recordID=<?php echo $row_Recordset1['codigo']; ?>" class="style18"> <?php echo $row_Recordset1['codigo']; ?></a> </td>
          <td><?php echo $row_Recordset1['nome']; ?></td>
          <td><?php echo $row_Recordset1['nome_razao']; ?></td>
          <td><?php echo $row_Recordset1['fantasia']; ?></td>
          <td><?php echo $row_Recordset1['cpf']; ?> </td>
          <td align="center"><strong><a href="edd_clientes.php?codigo=<?php echo $row_Recordset1['codigo']; ?>">EDITAR</a></strong></td>
          </tr>
