...
<table width="100%" border="0" cellpadding="0" cellspacing=" 0">
  <tr>
    ...
    <td><span class="style7 style13 style13"><b><span class="style1">NOVA NOTA FISCAL</span><br />
          <b><b><a href="submenu1.php" target="center"> Fechar Janela</a></b></b></b></span></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><table border="0" cellspacing="3" cellpadding="0" class="verdana" width="724" >
      <form action="" method="post" name="form1" id="form1">
        <tr>
          <td width="523" height="40" valign="top"><table width="654" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="229" valign="top"><b>Vendedor:<br /> 
                    <input name="textfield" type="text" id="textfield" value="<?php echo $_SESSION['MM_Username']; ?>" />
                    <br />
                </b></td>
                <td width="291" valign="top"><b>Cliente:</b><br />
                  <select name="jumpMenu" size="1" id="jumpMenu" onchange="MM_jumpMenu('parent',this,0)">
                    <option value="" selected="selected">Selecione</option>
                    <?php
do {  
?>
                    <option value="add_nota1.php?recordID=<?php echo $row_Recordset1['codigo']; ?>"><?php echo $row_Recordset1['nome']?></option><?php
