...
<table width="100%" border="0" cellpadding="0" cellspacing=" 0">
  ...
  <tr>
    ...
    <td><table width="100%" border="0">
        <tr bgcolor="#FFFFCC">
          <td class="style16">Codigo</td>
          <td class="style16">Nome</td>
          <td class="style16">CPF</td>
          <td class="style16">email</td>
        </tr>
        <?php do { ?>
        <tr>

          <td><a href="edddados_clientes2.php?recordID=<?php echo $row_Recordset1['codigo']; ?><?php echo $row_Recordset1['nome']?>" class="style18"> <span class="style17"><?php echo $row_Recordset1['codigo']; ?></span></a> </td>
          <td><span class="style19"><?php echo $row_Recordset1['nome']; ?></span>&nbsp; </td>
          <td><span class="style19"><?php echo $row_Recordset1['cpf']; ?></span> </td>
          <td class="style19"><?php echo $row_Recordset1['email']; ?></td>
        </tr>
...
<a href="edddados_cliente.php" class="style19">Fazer nova busca</a>
</body>
</html>
<?php
