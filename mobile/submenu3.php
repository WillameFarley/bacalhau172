...
<table width="1006" height="460" border="0" align="center">
  <tr>
    ...
    <div align="center"><span class="style2">CADASTRO DE FUNCIONÁRIOS</span></div></td>
  </tr>
  <tr>
    <td>
    <ul class="nav">
<li><a href="add_funcionarios.php" target="palco">Adicionar Funcionário</a></li>
<li><a href="edd_funcionarios.php" target="palco">Editar Funcionário</a></li>
<li><a href="exx_funcionarios.php" target="palco">Excluir Funcionario</a></li>
