...
$query_Recordset1 = "SELECT * FROM notafiscal";
...
<body>
<div class="style1" id="apDiv1"><?php echo $row_Recordset1['Cnpj']; ?></div>
<div class="style7" id="apDiv2"><?php echo $row_Recordset1['Cod_Equipamento']; ?></div>
<div class="style1" id="apDiv3"><?php echo $row_Recordset1['saida']; ?></div>
<div class="style1" id="apDiv4"><?php echo $row_Recordset1['entrada']; ?></div>
<div class="style1" id="apDiv5"><?php echo $row_Recordset1['Insc_Est_Sub_Trib']; ?></div>
<div class="style1" id="apDiv7"><?php echo $row_Recordset1['Cliente']; ?></div>
<div class="style1" id="apDiv8"><?php echo $row_Recordset1['Municipio']; ?></div>
<div class="style1" id="apDiv9"><?php echo $row_Recordset1['data_emissao']; ?></div>
<div class="style1" id="apDiv10"><?php echo $row_Recordset1['data_saida']; ?></div>
<div class="style1" id="apDiv11"><?php echo $row_Recordset1['endereco']; ?></div>
<div class="style1" id="apDiv12"><?php echo $row_Recordset1['bairro']; ?></div>
<div class="style1" id="apDiv13"><?php echo $row_Recordset1['cep']; ?></div>
...
<p class="style1">&nbsp;</p>
<p class="style1"></p>
<div class="style1" id="apDiv41"><?php echo $row_Recordset1['cfop']; ?></div>
<p class="style1">&nbsp;</p>
