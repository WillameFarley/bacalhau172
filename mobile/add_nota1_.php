  ...
  <tr>
    <td colspan="2">
      <table border="0" cellspacing="3" cellpadding="0" class="verdana" width="954" >
        ...
        <tr>
          <td width="100%" height="40" valign="top"><p><br />
              </p>
            <p>&nbsp;</p>
            <p><br />
              </p>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="10%" valign="top"><b>Data 
      Entrada:</b><br />
                        <b>
                        <input name="Data_Entrada2" type="text" class="select" id="Data_Entrada2" onkeypress="formatar(this, '##/##/####')" size="10" maxlength="10" />
                      </b></td>
    <td width="11%" valign="top"><b>Hora 
      do Pedido: <br />
                        <input name="Hora_Entrada2" type="text" class="select" id="Hora_Entrada2" onkeypress="formatar(this, '##:##')" size="5" maxlength="5" />
    </b></td>
    <td width="17%" valign="top"><b>Quem recebe o pedido:</b><br />
        <b>
        <input name="Patrimonio2" type="text" class="select" id="Patrimonio2" size="20" maxlength="10" />
        </b>
        </p>
    </td>
    <td width="13%" valign="top"><b>Data 
      da Entrega:</b><br />
                        <b>
                        <input name="Data_Entrega2" type="text" class="select" id="Data_Entrega2" onkeypress="formatar(this, '##/##/####')" size="10" maxlength="10" />
                      </b></td>
    <td width="15%" valign="top"><b>Hora 
      da Entrega: <br />
                        <input name="Hora_Entrega2" type="text" class="select" id="Hora_Entrega2" onkeypress="formatar(this, '##:##')" size="5" maxlength="5" />
    </b></td>
    <td width="13%" valign="top"><b>Data da Cobran&ccedil;a:</b><br />
                        <b>
                        <input name="Data_Cobanca2" type="text" class="select" id="Data_Cobanca2" onkeypress="formatar(this, '##/##/####')" size="10" maxlength="10" />
      </b></td>
    <td colspan="2" valign="top"><b>Prazo de Pgto:</b><br />
        <b>
        <input name="Prazo_Pgto2" type="text" class="select" id="Prazo_Pgto2" onkeypress="formatar(this, '##/##/####')" size="10" maxlength="10" />
      </b></td>
  </tr>
  <tr>
    <td valign="top">&nbsp;</td>
    <td valign="top">&nbsp;</td>
    <td valign="top">&nbsp;</td>
    <td colspan="2" valign="top"><input type="submit" name="button" id="button" value="Emitir Nota Fiscal" />
