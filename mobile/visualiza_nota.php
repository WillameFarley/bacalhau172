...
$query_Recordset1 = "SELECT * FROM nota WHERE Arquivo = 'n'";
...
<table width="100%" border="0" cellpadding="0" cellspacing=" 0">
  ...
  <tr>
    ...
    <td><table width="100%" border="0" align="center">
        <tr bgcolor="#FFFFCC">
          <td width="25%"><div align="center"><strong>NOTA FISCAL</strong></div></td>
          <td width="15%"><div align="center"><strong>DATA DA EMISS&Atilde;O</strong></div></td>
          <td width="33%"><div align="center"><strong>CLIENTE</strong></div></td>
          <td width="27%"><div align="center"><strong>VALOR</strong></div></td>
        </tr>
        <?php do { ?>
          <tr>
            <td valign="top"><div align="center"><a href="confirma_print_nota.php?recordID=<?php echo $row_Recordset1['Cod_Nota']; ?>" class="style17"><strong><?php echo $row_Recordset1['Cod_Nota']; ?></strong></a></div></td>
            <td valign="top"><?php echo $row_Recordset1['Data_Emissao']; ?>&nbsp; </td>
            <td valign="top"><?php echo $row_Recordset1['Cliente']; ?>&nbsp; </td>
            <td valign="top"><div align="center"><?php echo $row_Recordset1['Vl_Total_Nota']; ?>&nbsp; </div></td>
          </tr>
