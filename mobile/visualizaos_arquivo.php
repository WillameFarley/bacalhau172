...
$query_Recordset1 = "SELECT * FROM ordemservico WHERE Arquivo = 's'";
...
<table width="100%" border="0" cellpadding="0" cellspacing=" 0">
  ...
  <tr>
    ...
    <td><table width="100%" border="0" align="center">
        ...
        <?php do { ?>
          <tr>
            <td><a href="confirma_print2.php?recordID=<?php echo $row_Recordset1['Cod_Equipamento']; ?>" class="style17"> <?php echo $row_Recordset1['Cod_Equipamento']; ?></a> </td>
