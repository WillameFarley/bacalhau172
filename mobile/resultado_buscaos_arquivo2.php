...
$query_Recordset1 = sprintf("SELECT * FROM ordemservico WHERE Cliente LIKE %s and Arquivo = 's' ORDER BY Cliente ASC", GetSQLValueString($colname_Recordset1 . "%", "text"));
...
<a href="buscaos_arquivo2.php" class="style19">Fazer nova busca</a>
</body>
</html>
<?php
