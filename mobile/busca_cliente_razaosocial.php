...
<table width="100%" border="0" cellpadding="0" cellspacing=" 0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td><form id="form1" name="form1" method="get" action="resultado_busca_cliente_razaosocial.php">
      <table width="374" border="0">
        <tr>
          <td width="220" align="right" class="style7 style13 style13">Localizar Cliente pela Raz&atilde;o Social:</td>
