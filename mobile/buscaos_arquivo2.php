...
<table width="100%" border="0" cellpadding="0" cellspacing=" 0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td><form id="form1" name="form1" method="get" action="resultado_buscaos_arquivo2.php">
      <table width="332" border="0">
        <tr>
          <td width="178" class="style7 style13 style13">Localizar Pedido pelo Cliente:</td>
