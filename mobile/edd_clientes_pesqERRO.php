...
<table width="100%" border="0" cellpadding="0" cellspacing=" 0">
  <tr>
    ...
    <td><span class="style7 style13 style13"><b><span class="style1">EDITAR CLIENTE</span><br />
      ...
      <form action="" method="post" name="form1" id="form1">
        <tr>
          <td width="523" height="40" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td valign="top"><b>Selecione o Cliente Desejado:</b><br />
                  <select name="jumpMenu" id="jumpMenu" onchange="MM_jumpMenu('parent',this,0)">
                    <option value="">Selecione</option>
                    <?php
do {  
?>
                    <option value="edd_clientes.php?recordID=<?php echo $row_Recordset1['codigo']; ?>"><?php echo $row_Recordset1['nome']?></option><?php
