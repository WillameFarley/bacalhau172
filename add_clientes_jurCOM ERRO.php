...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="form1" onsubmit="MM_validateForm('nome','','R','email','','NisEmail');return document.MM_returnValue">
  <table width="890" border="0" cellpadding="0" cellspacing=" 0">
    <tr>
      ...
      <td width="400"><span class="style7 style13 style13"><b><strong><b><span class="style3">CADASTRO DE CLIENTES PESSOA JURÍDICA</span></b></strong><br />
            <b><b><a href="center1.php" target="palco">Fechar Janela</a></b></b></b></span></td>
      <td width="360"><ul class="nav">
          <li><a href="add_clientes.php" target="palco">CLIQUE AQUI PARA CADASTRAR PESSOA FÍSICA</a></li>
        </ul></td>
      <td width="130">&nbsp;</td>
    </tr>
  </table>
  <table width="892" border="0" cellpadding="2" cellspacing="2" class="verdana" >
    ...
    <tr>
      <td width="300" valign="top"><font color="#666666"><b>Razão Social:</b><br />
        ...
        <b>Nome de Fantasia:</b><br />
            <input name="razao" type="text" class="select" id="razao" size="50" maxlength="80" onkeyup="muda(this)"/>
            <br />
      <b>Proprietário:</b><br />
      ...
      <td width="185" valign="top"><b><font color="#666666"><b>Tipo de Cliente:<br />
        ...
        <select spry:sort="$tipo_cliente" name="tipo_cliente2" id="tipo_cliente2">
          <option> </option>
          <option>Vivo</option>
      ...
      <td width="205" valign="top"><label><span class="style2">Foto:</span><br />
      </label></td>
    </tr>
    <tr>
      ...
      <td width="205" valign="top"><font color="#666666"><b>Fone 
              Comercial:</b><br />
              <b>
              <input type="text" name="foneC2" class="select" maxlength="36" size="30" />
              </b></font></td>
    </tr>
    <tr>
      ...
      <td width="205" valign="top"><font color="#666666"><b> Fone 
              Resid:</b><br />
              <b>
              <input type="text" name="foneR" class="select" maxlength="36" size="30" />
              </b><b></b></font></td>
    </tr>
    <tr>
      ...
      <td width="205" valign="top"><font color="#666666"><b>Celular:<br />
    ...
    <tr>
      ...
      <td valign="top"><font color="#666666"><b><font color="#666666"><b>Estado:</b><br />
              <select name="estado2" size="1" class="select">
    ...
    <tr>
      <td colspan="5"><font color="#666666"><b>Link do Mapa:</b><br />
          <b>
          <input name="email3" type="text" class="select" id="email3" size="140" maxlength="512" />
          </b> </font></td>
    </tr>
    <tr>
      <td valign="top">&nbsp;</td>
