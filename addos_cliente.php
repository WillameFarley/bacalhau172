...
<table width="100%" border="0" cellpadding="0" cellspacing=" 0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td><form id="form1" name="form1" method="get" action="addos_cliente1.php">
      <table width="548" border="0">
        <tr>
          <td width="236" class="style7 style13 style13"><div align="right">Localizar Cliente pelo nome:</div></td>
