...
<table width="100%" border="0" cellpadding="0" cellspacing=" 0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td><form id="form1" name="form1" method="get" action="resultado_busca_vendedor.php">
      <table width="308" border="0">
        <tr>
          <td width="154" class="style7 style13 style13"><div align="right">Localizar Pedidos do Vendedor:</div></td>
            <td width="144">
              <div align="left"><span class="style7 style13 style13">
