...
<table width="100%" border="0" cellpadding="0" cellspacing=" 0">
  ...
  <tr>
    ...
    <td><table width="100%" border="0" align="center">
        <tr bgcolor="#FFFFCC">
          <td><div align="center"><strong>PEDIDO</strong></div></td>
          <td><div align="center"><strong>Funcion&aacute;¡rio</strong></div></td>
          <td><div align="center"><strong>Data de Entrada</strong></div></td>
          ...
          <td><div align="center"><strong>Data de Entrega</strong></div></td>
          <td><div align="center"><strong>Valor</strong></div></td>
        </tr>
        <?php do { ?>
          <tr>
            <td><div align="center"><a href="confirma_print.php?recordID=<?php echo $row_Recordset1['Cod_Equipamento']; ?>" class="style17"><strong> <?php echo $row_Recordset1['Cod_Equipamento']; ?></strong></a> </div></td>
            <td><?php echo $row_Recordset1['Funcionario']; ?>&nbsp; </td>
            <td><?php echo $row_Recordset1['Data_Entrada']; ?>&nbsp; </td>
            <td><?php echo $row_Recordset1['Cliente']; ?>&nbsp; </td>
            <td><?php echo $row_Recordset1['Equipamento']; ?><?php echo $row_Recordset1['Prod1']; ?>&nbsp; </td>
            <td><?php echo $row_Recordset1['Marca']; ?>&nbsp; </td>
            <td><?php echo $row_Recordset1['Dataentrega']; ?>&nbsp; </td>
...
<?php } while ($row_Recordset1 = mysql_fetch_assoc($Recordset1)); ?>
      ...
      <p><b>
        <input name="data_nin" type="text" class="select" id="data_nin" size="5" maxlength="10" />
      </b>
        <b>
        <input name="data_fim" type="text" class="select" id="data_fim" size="5" maxlength="10" />
        </b>
        <?php 
		$data_ini = '00/00/0000';
		$data_fim = '00/00/0000';
		"SELECT * FROM ordemservico WHERE Data_Entrega BETWEEN $data_ini AND $data_fim";
	  ?>
      </p></td>
  </tr>
</table>
