...
<table width="100%" border="0" cellpadding="0" cellspacing=" 0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td><form id="form1" name="form1" method="get" action="resultado_busca_cliente_nomefantasia.php">
      <table width="429" border="0">
        <tr>
          <td width="269" align="right" class="style7 style13 style13">Localizar Cliente pelo Nome de Fantasia:</td>
