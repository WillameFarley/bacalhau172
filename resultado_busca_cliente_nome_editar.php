...
<table width="100%" border="0" cellpadding="0" cellspacing=" 0">
  <tr>
    <td width="41"><div align="center"><img src="Imagens/cadeado.gif" alt="" width="30" height="30" /></div></td>
    <td width="275"><strong><b>SYSESTOQUE ::: BACALHAU 172</b><br />
  ...
  <tr>
    ...
    <td colspan="2"><table width="100%" height="56" border="1" bordercolor="#CCCCCC">
        <tr bgcolor="#FFFFCC">
          ...
          <td width="36%" align="center"><strong>NOME DO CLIENTE / NOME DE FANTASIA</strong></td>
          <td width="36%" align="center"><strong>RAZ&Atilde;O SOCIAL</strong></td>
