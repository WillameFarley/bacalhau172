...
<table width="100%" border="0" cellpadding="0" cellspacing=" 0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td><form id="form1" name="form1" method="get" action="resultado_busca_cliente_nome_editar.php">
      <table width="454" border="0">
        <tr>
          <td width="300" class="style7 style13 style13"><div align="right">Localizar Cliente pelo <strong>Nome do Cliente</strong>:</div></td>
        ...
        <tr>
          ...
          <td align="center"><span class="style7 style13 style13">
