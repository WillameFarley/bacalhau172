  ...
  <table width="100%" border="0" cellpadding="0" cellspacing=" 0">
    <tr>
      ...
      <td width="360"><ul class="nav">
          <li><a href="add_clientes_jur.php" target="palco" class="style6">CLIQUE AQUI PARA CADASTRAR PESSOA JURÍDICA</a></li>
      </ul></td>
      <td width="130">&nbsp;</td>
    </tr>
  </table>
  <table width="907" border="0" cellpadding="2" cellspacing="2" class="verdana" >
    ...
    <tr>
      ...
      <td width="30" valign="top"><font color="#666666"><b> Cep. 1:<br />
    ...
    <tr>
      ...
      <td width="30" valign="top"><font color="#666666"><b> Cep. 2:<br />
    ...
    <tr>
      ...
      <td width="30" valign="top"><font color="#666666"><b> Cep. 3:<br />
        <input name="cep3" type="text" class="select" id="cep3" onkeypress="formatar(this, '#####-###')" size="15" maxlength="9"/>
      </b></font></td>
...
<select spry:sort="$tipo_cliente" name="tipo_cliente" id="tipo_cliente">
  ...
  <option>Furnas</option>
    ...
    <tr>
      ...
      <td width="140"><font color="#666666"><br />
      </font></td>
    </tr>
    <tr>
